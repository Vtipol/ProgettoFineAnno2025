...
public class LedgeLookDownCinemachine3 : MonoBehaviour
{
    [Header("References")]
    ...
    void Update()
    {
        ...
        // If no ground detected ahead, move camera down
        float desiredYOffset = (hit.collider == null) ? ledgeLookDownOffset : originalOffset.y;
