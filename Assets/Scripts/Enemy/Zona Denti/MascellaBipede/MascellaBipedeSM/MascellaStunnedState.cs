...
public class MascellaStunnedState : MascellaState
{
    ...
    public override void OnUpdate()
    {
        ...
        PlayClipAtPosition(mascellaController.mascellaDeath, transform.position, 20000f); 

    }
    public static void PlayClipAtPosition(AudioClip clip, Vector3 position, float volume)
    {
